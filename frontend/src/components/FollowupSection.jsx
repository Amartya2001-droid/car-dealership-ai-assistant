...
const FollowupSection = ({ followups }) => {
  ...
  return (
    <Card className="shadow-none" data-testid="followup-section">
      <CardHeader>
      ...
      <CardContent>
        {followups.length === 0 ? (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-xs text-muted-foreground/70 mt-1">Opted-in callers will show up here for next-business-day outreach.</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span className="text-xs text-muted-foreground">{followupDate}</span>
                  </div>
                  {followup.leadId && (
